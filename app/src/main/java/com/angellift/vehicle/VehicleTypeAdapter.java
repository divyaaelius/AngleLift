...
public class VehicleTypeAdapter extends RecyclerView.Adapter<VehicleTypeAdapter.ViewHolder> {
    ...
    private List<VehicalTypeModel> data;

    public VehicleTypeAdapter(List<VehicalTypeModel> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.item_vehicle_typeadpter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        VehicalTypeModel VehicalTypeModel = data.get(position);
        holder.imageView.setBackgroundResource(VehicalTypeModel.getBaseDistance());
      /*  Glide.with(holder.itemView.getContext())
                .load(VehicalTypeModel.getBaseDistance())
                .listener(new TintOnLoad(holder.imageView, iconTint))
                .into(holder.imageView);*/
        holder.textView.setText(VehicalTypeModel.getName());
    }
